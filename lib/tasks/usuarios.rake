namespace :usuarios do
  ...
  task adicionar_avaliadores: :environment do
      ...
      avaliador1 = Usuario.create(nome: 'Sônia Cristina Ferreira Maia', email: 'sonia.maia@ifrn.edu.br', password: '#$852$#', perfil: membro_comissao_cientifica)
      ...
      Membro.create(linha: linha_congic_saude_coletiva, organizador: avaliador1, coordenador: false)
    ...
    Trabalho.all.each do |trabalho|
      ...
      avaliacoes.each do |avaliacao|
        ...
        if avaliacao.situacao == 0 && trabalho.linha.evento.nome != "VI MOSTRA TECNOLÓGICA"
          puts trabalho.linha.evento.nome+";"+trabalho.linha.nome+";"+trabalho.id.to_s+";"+avaliador.nome+";"+avaliador.email
        end
      end
    end
  end
