...
ActiveRecord::Schema.define(version: 2018_11_14_121505) do
  ...
  create_table "linhas", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "evento_id"
    t.index ["evento_id"], name: "index_linhas_on_evento_id"
  end
  ...
  create_table "participantes", id: :serial, force: :cascade do |t|
    ...
    t.bigint "campus_id"
    t.index ["campus_id"], name: "index_participantes_on_campus_id"
  ...
  create_table "trabalhos", id: :serial, force: :cascade do |t|
    ...
    t.integer "situacao"
    t.string "arquivo_final_file_name"
    t.string "arquivo_final_content_type"
    t.integer "arquivo_final_file_size"
    t.datetime "arquivo_final_updated_at"
    t.boolean "certificado"
